...
graphDir="E:/Scripts/Dec2020/ToGeoTIFF.xml"
...
for d in dirs:
   ...
   os.chdir(inImgDir)
   imgs=FoldersManager.getFilesNames(d,".dim")
   for img in imgs:
...
# python automatedERStoGeoTiff.py -inImgDir "E:\ASTARTE_Data\Level1\ERS-1" -outImgDir "E:\ASTARTE_Data\Level2\ERS-1" > "E:\Scripts\Dec2020\ERS1toGeoTiff.bat"
# python automatedERStoGeoTiff.py -inImgDir "E:\ASTARTE_Data\Level1\ERS-2" -outImgDir "E:\ASTARTE_Data\Level2\ERS-2" > "E:\Scripts\Dec2020\ERS2toGeoTiff.bat"
