...
for d in dirs:
   ...
   for img in imgs:
      ...
      if not os.path.isfile(imgOutDir1 +".dim"):
         print ("gpt \""  + graphDir +"\" -Pin=\""+ imgInDir1 + "\" -Pout=\""+ imgOutDir1 +".tif\"\n")
...
# python toGeoTIFF.py -inImgDir "E:\ASTARTE_Data\Level1" -outImgDir "G:\Level2" > "E:\Scripts\Dec2020\ToGeoTiff.bat"
