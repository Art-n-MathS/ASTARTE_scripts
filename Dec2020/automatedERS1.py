...
graphDir="E:/Scripts/Dec2020/ERS1-2_new.xml"
...
for d in dirs:
   ...
   os.chdir(inImgDir)
   imgs=FoldersManager.getFilesNames(d,".E1")
   for img in imgs:
...
# TO DO: Modify E2/E1 at Line 47
# python automatedERS1.py -inImgDir "E:\ASTARTE_Data\Level0\ERS-1" -outImgDir "E:\ASTARTE_Data\Level1\ERS-1" > "E:\Scripts\Dec2020\ERS1.bat"
# python automatedERS1.py -inImgDir "E:\ASTARTE_Data\Level0\ERS-2" -outImgDir "E:\ASTARTE_Data\Level1\ERS-2" > "E:\Scripts\Dec2020\ERS2.bat"
