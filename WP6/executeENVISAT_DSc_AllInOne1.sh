...
indir="/run/media/milto/Seagate Expansion Drive/ASTARTE_data/Level3/"
outdir="/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"


# 201
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"201.csv" -zones 201 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 202
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"202.csv" -zones 202 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 201,202
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"201-202.csv" -zones 201,202 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 302
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"302.csv" -zones 302 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 301
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"301.csv" -zones 301 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 302,301
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"301-302.csv" -zones 301,302 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 401
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"401.csv" -zones 401 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 402
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"402.csv" -zones 402 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 401,402 
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"401-402.csv" -zones 401,402 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 201,301,401
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"201-301-401.csv" -zones 201,301,401 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 202,302,402
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"202-302-402.csv" -zones 202,302,402 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS

# 201,202,301,302,401,402
python TimeseriesInOneCsvPerSattelite/mainAllInOne.py -in "$indir$satellite/$ascORdesc/$polarization/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/"$satellite"/"$ascORdesc"/"$polarization"/"$satellite$polarization"201-202-301-302-401-402.csv" -zones 201,202,301,302,401,402 -MS $MS -ME $ME -YS $YS -YE $YE -IDS $IDS
