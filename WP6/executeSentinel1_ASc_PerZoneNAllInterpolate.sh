...
# 201
python TimeseriesInOneCsvPerSattelite/mainSentinel1AscInterpolate.py -in "/run/media/milto/Seagate Expansion Drive/ASTARTE_data/Level3/Sentinel-1/ASCENDING/VH/" -out "/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/Sentinel-1/ASCENDING/VH/Sentinel1_VH_201.csv" -zones 201
...
bodydir="/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/Sentinel-1/ASCENDING/VH/"
polarization="VH"
...
bodydir="/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/Sentinel-1/ASCENDING/VV/"
polarization="VV"
# remove previously created folders
rm -r $bodydir"singles" # 201 , 202 , 301 , 302 , 401 , 402 , 201,202,301,302,401,402
rm -r $bodydir"heights" # 201,202 , 301,302 , 401,402 , 201,202,301,302,401,402
