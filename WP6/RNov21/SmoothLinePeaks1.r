...
originalNormalisedArray = originalArray
...
smoothedNormalisedArray = smoothedArray
...
amplitudesOriginalNormalisedArray = amplitudesOriginalNonNormalisedArray
...
amplitudesSmoothedNormalisedArray = amplitudesSmoothedNonNormalisedArray
...
plot(peaksOriginalArray, amplitudesOriginalNormalisedArray,xlab=xAxisTitle, ylab=yAxisTitle, lwd=2,cex.lab=3,cex.axis=2.5, xlim=c(0,x), ylim=c(0,1),col="darkgreen")
