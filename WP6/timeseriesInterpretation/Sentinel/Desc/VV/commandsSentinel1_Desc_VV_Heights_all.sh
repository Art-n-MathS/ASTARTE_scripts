...
year=all    # TO BE CHANGED as well as input name
baseDir="/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/Sentinel-1/DESCENDING/VV/heights/ALL/"
...
input=$baseDir"all_s1_Dsc_vv.csv" # TO BE CHANGED 
