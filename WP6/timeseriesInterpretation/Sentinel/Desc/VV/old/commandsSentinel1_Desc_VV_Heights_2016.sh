...
baseDir="/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/Sentinel-1/DESCENDING/VV/heights/perYear/"$year"/"
sattelite="Sentinel-1 Descending VV"
width=900
height=400
minWidth=3.0
...
input=$baseDir"Sentinel-1_Desc_VV_heights_all_2016.csv" # TO BE CHANGED 
