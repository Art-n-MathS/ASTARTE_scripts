...
baseDir="/home/milto/Documents/ASTARTE/ASTARTE_sample_data/level4/Sentinel-1/ASCENDING/VV/heights/perYear/"$year"/"
sattelite="Sentinel-1 Ascending VV"
width=900
height=400
minWidth=3.0
...
input=$baseDir"Sentinel-1_Asc_VV_heights_all_2014.csv" # TO BE CHANGED 
