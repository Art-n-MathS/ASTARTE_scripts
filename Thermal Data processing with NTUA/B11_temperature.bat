...
set SPECT_RAD=%str%_b11%S_R% 
set TEMP_KELVIN=%str%_b11%T_k% 
set CL_NDVI=%str%%S_V% 
set PAR_PV=%str%_b11%pv% 
set EMISSIVITY=%str%_b11%em% 
set TEMP_LAND=%str%_b11%T_l% 
set TEMP_CELSIUM=%str%_b11%T_c% 
